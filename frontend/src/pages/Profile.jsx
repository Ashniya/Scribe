                    ...
                    <div className="px-4">
                        ...
                        {isEditing ? (
                            ...
                            <div className="mb-6 text-center">
                                ...
                                <div className={`mt-2 text-xs font-medium ${isDark ? 'text-white' : 'text-gray-900'}`}>{profile.followerCount || 0} <span className="font-normal text-gray-500">subscribers</span></div>
                        ...
                        <div className="space-y-4 pb-20">
                            {activeTab === 'activity' && (
                                <div className="space-y-4">
                                    ...
                                    <div className={`p-4 rounded-lg border ${isDark ? 'border-slate-800' : 'border-gray-100'}`}>
                                        <div className="flex gap-2 mb-2">
                                            <div className="w-6 h-6 rounded-full bg-scribe-green text-white flex items-center justify-center text-[10px]">
                                                PS
                                            </div>
                                            <div>
                                                <p className={`text-xs font-medium ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Practical Stoic Advice <span className="text-scribe-green">✓</span></p>
                                                <p className={`text-[10px] ${isDark ? 'text-gray-500' : 'text-gray-500'}`}>Advice no one wants to hear:</p>
                                            </div>
                                        </div>
                                        <p className={`mb-3 text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                                            You HAVE to put in the work or it isn't going to happen.
                                            This means, yes, you're going to need to actually work constantly for a solid year to reach your goals.
                                        </p>
                                        <div className={`flex items-center gap-4 text-xs ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                                            <span className="flex items-center gap-1"><span className="text-red-500">♥</span> 3.7K</span>
                                            <span>💬 28</span>
                                            <span>↻ 360</span>
                                        </div>
                                    </div>
